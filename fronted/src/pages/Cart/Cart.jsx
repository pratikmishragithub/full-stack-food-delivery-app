         ...
         if(cartItems[item._id]>0)
         {
          return(
            <div>
              ...
              <p>{item.name}</p>
              <p>${item.price}</p>
             {/* cartItems[item._id] tells about item quantity. */}
      ...
      <div className="cart-bottom">
       <div className="cart-total">
        ...
        <div className="cart-total-details">
         ...
         <div className="cart-referalcode">
          <div>
            <p> If you have a referal code, Enter it here </p>
            <div className='cart-referalcode-input'>
